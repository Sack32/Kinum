     ...
     <header class="navbar-fixed-top">
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
          ...
          <li class="dropdown" class="active"><a class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>SignUp<span class="caret"></span></a>
      ...
      <p><br/></p>
       <legend style="text-align: center">
        <a href="index.php"><img src="img/cart1.png" alt="logo" style="width: 200px; height: 90px;" /></a>
 		 ...
 		 <div class="well" style="width: 600px;margin: auto;text-align: center; "><h1>SignUp As Staff</h1> 
      <div class="well" style="background-color:#f0fff0;width: 500px;margin: auto;">
       <p><br></p>
        ...
        <div class="form-group">
              ...
              <div class="col-sm-3">          
                <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pwd" style="width: 230px;"equired>
              </div>
          </div>
          <div class="form-group">
